...
<?php }else echo stripslashes_deep($macro); ?>
					...
					<div class='aft_attention'>
						...
						<ul>
							...
							<li class='aft_macro_info'><p>$res .= $pr->set_catname($catname); - Задает категорию, в которую публикуется материал. Если категория с таким именем не существует - она будет создана. Этот параметр можно не указывать, если вы хотите настроить этот парсер только для одной категории.</p></li>
