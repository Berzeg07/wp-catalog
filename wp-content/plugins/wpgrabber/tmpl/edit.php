...
<div id="icon-edit" class="icon32"></div><h2>WPGrabber - <?php echo $isNew ? 'Новая лента *' : 'Редактирование ленты'; ?> - 
    <a href="http://wpgrabber.biz/trade/wpgrabber-plugin/nastrojka-wpgrabber/" target="_blank" title="Заказать платную настройку лент"><b>Заказать настройку ленты</b></a></h2>
